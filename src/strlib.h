...
void	R2_truncate(char *);		//  Remove trailing spaces from
					//  a string
int	R2_read_line(FILE *, char *); //  Read in a line from a file
int	R2_find_word(const char *, const char *); //  Check for given word in a
					//  string
int	R2_blank_string(char *);	//  Check to see if a string
					//  is blank
void	R2_find_first_word(char *, char *);
					//  Find the first word in a string
int	R2_read_int(FILE *, const char *);  //  Read an integer from a file
void	R2_pad(char *, size_t);	//  Pad a string with leading spaces
void	R2_remove_comment(char *);	//  Remove comments at the end of
					//  a line demarked by !
