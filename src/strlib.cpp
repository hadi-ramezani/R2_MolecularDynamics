...
/*									*/
/*	R2_read_line reads in a line from an open file.  It places    */
...
/*			END OF FUNCTION R2_read_line			*/

/************************************************************************/
/*									*/
/*			FUNCTION R2_remove_comment			*/
/*									*/
/*   INPUTS:								*/
...
void R2_remove_comment(char *str)
...
/*			END OF FUNCTION R2_remove_comment		*/

/************************************************************************/
/*									*/
/*			FUNCTION R2_truncate				*/
/*									*/
/*   INPUTS:								*/
/*	str - string to truncate					*/
/*									*/
/*      R2_truncate will remove any trailing spaces from a string.    */
/*   i.e.  "AB DF FG     "  would be truncated to "AB DF FG".		*/
/*									*/
/************************************************************************/

void R2_truncate(char *str)
...
/*			END OF FUNCTION R2_truncate			*/

/************************************************************************/
/*									*/
/*			FUNCTION R2_find_word				*/
/*									*/
/*   INPUTS:								*/
...
/*									*/
/*	R2_find_word searches for one string within another.  It is   */
...
int R2_find_word(const char *source, const char *search)
...
/*			END OF FUNCTION R2_find_word			*/

/************************************************************************/
/*									*/
/*			FUNCTION R2_blank_str				*/
/*									*/
/*   INPUTS:								*/
/*	str - string to test						*/
/*									*/
...
/*   returned								*/
/*									*/
/*	R2_blank_str tests to see if a string is blank.  That is,     */
/*   contains only characters where isspace() is true			*/
/*									*/
/************************************************************************/

int R2_blank_string(char *str)
{
	int i;		// Current position in str
...
/*			END OF FUNCTION R2_blank_string		*/

/************************************************************************/
/*									*/
/*			FUNCTION R2_find_first_word			*/
/*									*/
/*   INPUTS:								*/
...
void R2_find_first_word(char *source, char *word)
...
/*			END OF FUNCTION R2_find_first_word		*/

/************************************************************************/
/*									*/
/*			FUNCTION R2_read_int 				*/
/*									*/
/*   INPUTS:								*/
...
/*									*/
/*	R2_read_int is used to read in integer lists from the .psf    */
...
int R2_read_int(FILE *fd, const char *msg)
...
void R2_pad(char *str, size_t length)
